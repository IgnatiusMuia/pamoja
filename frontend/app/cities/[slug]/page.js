        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {ACTIVITIES.slice(0, 12).map((a) => (
              ...
              >
                <span className="block h-8 w-8 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-700 font-extrabold flex items-center justify-center text-sm mb-1.5">
                  {a.label[0]}
                </span>
